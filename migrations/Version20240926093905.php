 ...
 */
final class Version20240926093905 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ingredient (id INT NOT NULL, sandwich_id INT DEFAULT NULL, name TEXT NOT NULL, PRIMARY KEY(id))');
